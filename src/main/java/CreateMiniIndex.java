...
public class CreateMiniIndex {
    ...
    public static void main(String[] args) throws IOException {
        ...
        addDoc(idx, "1234", "Macarena Prado",
                "Estructura de datos y algoritmos",
                "Un arreglo es una estructura indexada , bla bla bla" );

        addDoc(idx, "5678", "Macarena prado torres",
                "algoritmos en Java",
    ...
    {
//        Query query = new TermQuery(new Term("content", "bla"));          // searches words

//        Query query = new PhraseQuery("content","indexada","estructura");       // searches phrases

        Query query = new TermRangeQuery("content", new BytesRef("a"), new BytesRef("z"), false,false);     // searches by range, false is an open interval
