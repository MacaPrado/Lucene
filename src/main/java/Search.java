...
public class Search {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException, ParseException {
        // el indice esta en otro subdirectorio de LuceneDocs, se crea en CreateOrUpdateIndex
        ...
        searchIndex("content", "owner: makarena~1 AND content: estructura OR (alumno AND NOT ver)");
